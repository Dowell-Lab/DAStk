...
In release v0.3.0 two additional modules have been included:
...
### Inquiring TF-TF relations 

In release v0.3.3 a new functionality has been included, if using assays on human tissue and the TF motifs from HOCOMOCO:
